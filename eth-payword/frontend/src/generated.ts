...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link ethWordAbi}__ and `functionName` set to `"simulateCloseChannel"`
 */
export const useReadEthWordSimulateCloseChannel =
  /*#__PURE__*/ createUseReadContract({
    abi: ethWordAbi,
